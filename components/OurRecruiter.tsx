...
import image1 from '@assets/banner/ourrecuiters.jpg';
        ...
        <div className="relative h-[500px] overflow-hidden rounded-2xl shadow-2xl md:h-[600px]">
          ...
          <div className="absolute inset-0 z-20 flex flex-col items-center justify-center px-4 text-center text-white">
            <div className="absolute bottom-8 flex space-x-2">
              {slides.map((slide, index) => (
                <button
                  key={slide.id} // FIX 2: Used unique ID instead of index
                  aria-label={`Go to slide ${index + 1}`} // FIX 3: Added explicit button type
                  ...
                  }`} // FIX 4: Added function return type
                  type="button"
                  onClick={(): void => {
