...
const Members: React.FC<{ level: keyof typeof members }> = ({ level }) => (
  <>
    {members[level].map(({ name, linkedIn, designation }) => (
      <div key={cyrb53(name)} cx="member">
        <div cx="wrapper">
          ...
          <div cx="content">
            ...
            <h3 cx="faculty-designation">{designation}</h3>
          </div>
        </div>
      </div>
    ))}
...
const TeamHome: React.FC = () => (
  <section cx="sect" id="our-team">
    <div cx="ctr">
      ...
      <h3 cx="lead">Faculty Coordinators, Training and Placements</h3>
      <div cx="faculty-members">
